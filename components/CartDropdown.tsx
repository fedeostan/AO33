...
export default function CartDropdown({ onClose }: CartDropdownProps) {
  const { items, removeItem, total, handleWhatsAppCheckout } = useCart()
      ...
      <div className="absolute right-0 top-full mt-2 w-80 bg-[#1a1a1a] border border-white/10 rounded-lg shadow-2xl z-50 overflow-hidden">
        {items.length === 0 ? (
          <div className="p-6 text-center">
            ...
            <p className="text-white/60 text-sm">Tu carrito está vacío</p>
          </div>
        ) : (
          <>
            {/* Items */}
              ...
              {items.map((item, index) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="p-1 text-white/40 hover:text-[#e31937] transition-colors"
            ...
            <div className="p-4 bg-black/30 border-t border-white/10">
              ...
              <button
                ...
                className="w-full py-3 px-4 bg-[#25D366] hover:bg-[#20bd5a] text-white font-semibold rounded-lg transition-colors flex items-center justify-center gap-2"
              >
