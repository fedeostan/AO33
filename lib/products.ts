    ...
    colors: [
      {
        ...
        cutImage: '/images/illustrations/galeria/read_mark1 Background Removed.png',
      },
      {
        id: 'blanco',
        name: 'Blanco',
        ...
        cutImage: '/images/illustrations/galeria/mark1_white Background Removed.png',
      },
      {
        id: 'negro',
        name: 'Negro',
        ...
        cutImage: '/images/illustrations/galeria/mark1_black Background Removed.png',
      },
    ],
    sizes: SIZES,
    available: true,
    ...
    colors: [
      {
        ...
        cutImage: '/images/illustrations/galeria/mark2_arte_2 Background Removed.png',
      },
      {
        id: 'blanco',
        name: 'Blanco',
        ...
        cutImage: '/images/illustrations/galeria/mark2_creative Background Removed.png',
      },
      {
        id: 'negro',
        name: 'Negro',
        ...
        cutImage: '/images/illustrations/galeria/Mark2_arte_1 Background Removed.png',
      },
    ],
    sizes: SIZES,
    available: true,
    ...
    colors: [
      {
        ...
        cutImage: '/images/illustrations/Skinning Roll Background Removed.png',
      },
    ],
    sizes: SIZES,
    available: true,
